		...
		<!-- Header -->
			<div id="header">
				<div class="container">
					...
					<!-- Logo -->
						<!-- <h1><a href="#" id="logo">Farmer Connect</a></h1> -->
							...
							<div class="container">
								<section>
									<header class="major">
										...
										<span class="byline">&hellip; Nam in massa. Sed vel tellus. Curabitur sem urna, consequat vel, suscipit in, mattis placerat. <a href="http://templated.co">TEMPLATED</a>. Released for free under the <a href="http://templated.co/license">Commons Attribution</a>Nam in massa. Sed vel tellus. Curabitur sem urna, consequat vel, suscipit in, mattis placerat.</span>
									</header>
